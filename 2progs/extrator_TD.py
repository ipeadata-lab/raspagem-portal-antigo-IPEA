...
df_links_tipos_td = df_links_tipos[df_links_tipos['Tipo 2'] == 'Publicações - TDs (todos os anos)']
...
if len(df_links_tipos_td) >= 5:
    ...
    print(df_td)
    # Salva o DataFrame df_td em um arquivo CSV
    caminho_do_csv_saida = 'C:\\Users\\B03531855158\\Documents\\Extraçoes - Portal\\publicacoes_td.csv'
    df_td.to_csv(caminho_do_csv_saida, index=False)
    print(f"DataFrame salvo com sucesso em {caminho_do_csv}")
else:
